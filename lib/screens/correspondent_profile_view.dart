  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final isUploadingImage = auth.isLoading.value;
        ...
        Future<void> handleRefresh() async {
          await auth.forceRefreshAuth();
          if (role == 'correspondent' && schoolCtrl != null) {
            try {
              await schoolCtrl.getAllSchools();
            } catch (_) {
              // Silent fail — forceRefreshAuth already surfaces auth-related errors.
            }
          }
        }
                      ...
                      children: [
                        Stack(
                          ...
                          children: [
                            ...
                            // Small loading ring shown over an existing photo
                            // while a new one uploads, since the Center()
                            // spinner above only covers the no-photo state.
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (user?.schoolId != null) ...[
                          _divider(),
                          _infoRow(Icons.business_rounded, 'School ID', user!.schoolId.toString()),
                        ],
                      ],
                    ),
                  ),
